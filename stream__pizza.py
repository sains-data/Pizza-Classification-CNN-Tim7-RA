...
data_directory = pathlib.Path('/content/drive/MyDrive/deeplearning/test')
class_names = [item.name for item in data_directory.glob('*')][:2]
print(class_names)

pizza_dir = '/content/drive/MyDrive/deeplearning/train/pizza'
not_pizza_dir = '/content/drive/MyDrive/deeplearning/train/not_pizza'
data_dir = '/content/drive/MyDrive/deeplearning/train'
